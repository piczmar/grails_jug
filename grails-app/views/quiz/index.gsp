		...
		<div id="list-quiz" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="dateCreated" title="${message(code: 'quiz.dateCreated.label', default: 'Date Created')}" />
					
						<g:sortableColumn property="lastUpdated" title="${message(code: 'quiz.lastUpdated.label', default: 'Last Updated')}" />
				...
				<g:each in="${quizInstanceList}" status="i" var="quizInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:formatDate date="${quizInstance.dateCreated}" /></td>
					
						<td><g:formatDate date="${quizInstance.lastUpdated}" /></td>
			...
			<div class="pagination">
				<g:paginate total="${quizInstanceCount ?: 0}" />
			</div>
		</div>
	</body>
</html>
